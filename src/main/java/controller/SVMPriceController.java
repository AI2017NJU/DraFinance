...
//@Service("SVMPrice")
@Controller
public class SVMPriceController{//} implements SVMPriceService {
    /**取“一段时间”来预测，这里为7天*/
...
//    @Override
    public List<SVM> predictByOCHL_List(HttpServletRequest request){// String stockId) {
...
//            svmList.add(svm);
//        }
        List<String> dates=dayKDAO.getDates("SH600000");
        for(int i=0;i<dates.size();i++)
        {
            SVM svm=new SVM();
            svm.setDate(dates.get(i));
            svmList.add(svm);
        }
