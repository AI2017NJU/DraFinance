...
var preNavIndex;
var secondNavList = [
    '<div id="nav-sec0" class="nav-sec-item"><a href="#k_wrapper" class="targeted">K线图</a><a href="#macd_wrapper">MACD</a><a href="#rsi_wrapper">RSI</a><a href="#kdj_wrapper">KDJ</a><a href="#boll_wrapper">BOLL</a></div><a href="#"><img id="toTop" src="/img/top.png"/></a>'
    ,
    '<div id="nav-sec1" class="nav-sec-item"><a href="#grade_wrapper" class="targeted">股票评分</a><a href="#bench_relative_wrapper">大盘相关</a></div><a href="#"><img id="toTop" src="/img/top.png"/></a>'
    ,
    '<div id="nav-sec2" class="nav-sec-item"><a href="#forecast_one" class="targeted">走势预测</a><a href="#forecast_two">特殊预测</a></div><a href="#"><img id="toTop" src="/img/top.png"/></a>'
    ,
    '<div id="nav-sec3" class="nav-sec-item"><a href="#dynamic_trade_wrapper" class="targeted">实时交易</a><a href="#text_instruction">实时分析</a></div><a href="#"><img id="toTop" src="/img/top.png"/></a>'
    ,
    '<div id="nav-sec4" class="nav-sec-item"><a href="#company_intro" class="targeted">公司简介</a><a href="#news_news">新闻公告</a><a href="#news_paper">研究报告</a><a href="#company_profit">盈利能力</a></div><a href="#"><img id="toTop" src="/img/top.png"/></a>'
    ];
