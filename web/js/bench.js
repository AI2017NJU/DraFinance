...
var secondNavList = [
    ...
    '<div id="nav-sec2" class="nav-sec-item"><a href="#forecast_one" class="targeted">走势预测</a></div><a href="#"><img id="toTop" src="/img/top.png"/></a>'
    ,
    '<div id="nav-sec3" class="nav-sec-item"><a href="#dynamic_trade_wrapper" class="targeted">实时交易</a></div><a href="#"><img id="toTop" src="/img/top.png"/></a>'
    ,
    '<div id="nav-sec4" class="nav-sec-item"><a href="#range_wrapper" class="targeted">涨跌分布</a></div><a href="#"><img id="toTop" src="/img/top.png"/></a>'
   ];
